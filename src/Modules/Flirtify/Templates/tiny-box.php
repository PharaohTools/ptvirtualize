...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                array ( "Logging" => array( "log" => array( "log-message" => "Lets begin Configuration of a Bastion server on environment mypresentation"),),),
...
//                ), ), ),
                ...
                array ( "Logging" => array( "log" => array(
                    "log-message" => "Configuring a Bastion server on environment mypresentation complete"
                ),),),
