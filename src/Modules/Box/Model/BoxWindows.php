...
class BoxWindows extends BoxUbuntu {
    ...
    protected function downloadCall($source, $tmpFile) {
        ...
        stream_context_set_params($ctx, array("notification" => "\\Model\\BoxWindows::stream_notification_callback"));
    ...
    public static function stream_notification_callback($notification_code, $severity, $message, $message_code, $bytes_transferred, $bytes_max) {
