...
provisioning. Automating, versioning, standardising and managing the setup, teardown and provisioning of virtualised development environments for your
projects.
...
Using Phlagrant, Dapperstrano and Testingkamen, you can set up a reasonably solid PHP Configuration Managed stack of servers,
...
- Autopilot - Phlagrant Autopilot - User Defined Installations
...
- Cleofy - Phlagrant Cleofyer - Creates default autopilots for your project
- Phlagrant - Phlagrant - Upgrade or Re-install Phlagrant
...
- InstallPackage - Phlagrant Predefined Installers
...
- ModuleManager - Manage the modules used in Phlagrant
